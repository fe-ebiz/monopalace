...
<head>
    ...
    <link rel="stylesheet" href="../../static/fonts/nanumgothic/nanumgothic.css"> -->
    ...
    <link rel="stylesheet" href="http://static.monopalace.com/css/m/landing/contents.min.css">
...
<body id="landingInquiryPage">
    <div id="wrapper" class="wrapper">
            ...
            <div id="gnb" class="gnb">
                <div class="group-f gnb-area">
                    <div class="logo-bar">
                        ...
                        <a href="tel:041-585-0003" class="tel">
                            <img src="http://img.monopalace.com/m/landing/inquiry/inquiry_number.png" alt="분양문의 041 585 0003">
                        </a>
                    </div>
                    ...
                    <div class="navbar-wrapper">
                        <div id="navbar" class="navbar">
                            ...
                            <button type="button" class="ap-reset allmenu-toggle-btn" onclick="$('#allmenu').toggle()">
                                <span class="dot"></span>
                                <span class="dot"></span>
                                <span class="dot"></span>
                            </button>
                            <div class="allmenu" id="allmenu" style="display: none">
                                ...
                                <a href="javascript:;" class="close-btn" onclick="$('#allmenu').toggle()">
        ...
        <main id="container" class="container" role="main">
                ...
                <div class="visual-wrapper">
                    <div class="visual-content">
                        <div class="banner">
                            <div class="el">
                                <h1 class="title">
                                    <img src="http://img.monopalace.com/m/landing/inquiry/visual/title.png" alt="충남아산의 명품 랜드마크 모노팰리스">
                                </h1>
                                <figure class="picture">
                                    <img src="http://img.monopalace.com/m/landing/inquiry/visual/advantages.png" alt="156세대, 최적의 교통환경, 프리미엄 입지환경, 저렴한 분양가, 월세 수익 연 500만원">
                                </figure>
                            </div>
                        </div>
                        <div class="bannerbar">
                            <img src="http://img.monopalace.com/m/landing/inquiry/visual/bar_title.png" alt="5년간 임대수익보장!" class="bar-title">
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="premier-wrapper">
                    <div class="premier-content group-f">
                        <h1 class="title-type1 title">
                            <img src="http://img.monopalace.com/m/landing/inquiry/premier/title.png" alt="모노팰리스 분양 특급 프리미엄" class="no">
                        </h1>
                        ...
                        <div class="picture-list-wrapper">
                            <div class="picture-list ta-center" id="premierPictureList">
                            ...
                            <div id="bannerArrow" class="banner-arrow"></div>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="place-wrapper">
                    <div class="place-content group">
                        ...
                        <figure class="picture ta-center">
                            <img src="http://img.monopalace.com/m/landing/inquiry/place/img_1.png" alt="모노팰리스 입지환경 약도">
                        </figure>
                        <div class="subtext">
                            <p>
                                <span class="dot">-</span> 도보 7분거리 <span class="c-red">1호선 온양온천역으로 청량리, 광운대, 천안 등을 빠르게 이동</span> 가능
                            </p>
                            <p>
                                <span class="dot">-</span> <span class="c-red">이마트, 롯데마트, 롯데시네마, 온양전통시장</span> 등 편의시설이 잘 갖춰진 주거환경
                            </p>
                            <p>
                                <span class="dot">-</span> 도보 10분 거리 <span class="c-red">시외버스터미널, 코레일, 모노팰리스 바로앞 버스정류장</span>
                            </p>
                            <p>
                                <span class="dot">-</span> 교통 여건이 잘 갖추어져 있는 <span class="c-red">아산 최고 입지</span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section class="sec landing inquiry-sale-sec" id="scroll_sale">
                <div class="sale-wrapper">
                    <div class="sale-content group">
                        <h1 class="title-type1 title">
                            <img src="http://img.monopalace.com/landing/inquiry/sale/title.png" alt="모노팰리스 파격 분양혜택" class="no">
                        </h1>
                        <figure class="picture ta-center">
                            <img src="http://img.monopalace.com/landing/inquiry/sale/subtitle.png" alt="수익형 상품!">
                        </figure>
                        <figure class="picture ta-center">
                            <img src="http://img.monopalace.com/m/landing/inquiry/sale/img_1.png" alt="수익형상품, 후분양상품, 안정성 UP">
                            <div class="btn-area">
                                <img src="http://img.monopalace.com/m/landing/inquiry/sale/sgi.jpg" alt="SGI서울보증" class="sgi">
                        ...
                        <p class="subtitle-type1 subtitle">
                            건축 시행사가 준공 후 5년동안 직접 임대운영중인<br>
                            믿을 수 있는 후분양 상품입니다.<br>
                            모노팰리스 방문하시고,<br>
                            <span class="c-yellow td-under">전실 만실로 돌아 가는 것을 확인하고 계약 하세요!!</span>
                        </p>
                    </div>
                </div>
                <div class="income-wrapper">
                    <div class="income-content group">
                        <h1 class="title-type1 title">
                            <img src="http://img.monopalace.com/m/landing/inquiry/sale/income_title.png" alt="든든하다! 모노팰리스 임대수익" class="no">
                        </h1>
                        <p class="subtitle-type1 subtitle">
                            시중 예금 금리 인하, <span class="c-skyblue">평균 시중은행 예금 금리 1% 수준</span> <br>
                            <span class="c-red-dark">저금리 시대 최고의 수익률<i>!</i></span>
                        </p>
                        <figure class="picture-1 ta-center">
                            <img src="http://img.monopalace.com/m/landing/inquiry/sale/income_img_1.png" alt="1억 시중은행 예금상품 예치시 연 이자 1059950원">
                        </figure>
                        ...
                        <figure class="picture-2 ta-center bn">
                            <img src="http://img.monopalace.com/m/landing/inquiry/sale/income_bn_1.png" alt="실수입 보장" class="bn-1">
                        </figure>
                        <p class="subtext">
            ...
            <section class="sec landing inquiry-intro-sec" id="scroll_intro">
                <div class="intro-wrapper">
                    <div class="intro-content group">
                        ...
                        <figure class="picture ta-center">
                            <img src="http://img.monopalace.com/m/landing/inquiry/intro/img_1.png" alt="모노팰리스 소개이미지">
                        </figure>
                        ...
                        <div class="info-1">
                            ...
                            <p class="d-flex">
                                ...
                                <span class="ta-right">분양면적 : 45.82㎡(원룸·투베이),<br> 57.73㎡(원룸·투베이)</span>
                            </p>
                        </div>
                        <table class="info-tbl">
                            ...
                            <tr>
                                <th>건축규모</th>
                                <td>주거시설: 지상 3층 ~ 지상 15층 /<br> 상업시설: 지하 1층 ~ 지상 2층</td>
                            </tr>
                            <tr>
                                <th>세대정보</th>
                                <td>주상복합형 소형아파트 총 156세대</td>
                            </tr>
                            <tr>
                                <th>부대시설</th>
                                <td>편의점, 근린생활시설, 휘트니스센터, 주차타워, 관리사무소</td>
                            </tr>
                        </table>
                    </div>
                </div>
                                ...
                                <div class="type-info">
                                    <div class="d-flex">
                                        ...
                                        <div class="el">
                                            ...
                                            <p class="option-text">
                                                드럼세탁기, 원터치 전기 쿡탑, 벽걸이 에어컨,
                                                냉장고(255L), 32인치 LED TV, 아일랜드 식탁,
            ...
            <section class="sec landing inquiry-prefer-sec">
                <div class="prefer-wrapper">
                    <div class="prefer-content">
                        <h1 class="title-type1 title">
                            <img src="http://img.monopalace.com/m/landing/inquiry/prefer/title.png" alt="오피스텔형 주택 선호도 2위" class="no">
                        </h1>
                        <p class="subtitle-type1 subtitle">
                            <span class="c-blue">
                                통계청 자료에 따르면 1인가구는 584만 가구로<br> 1인 가구비율이 29.3%의 비중을 차지하며<br>
                                그 추세가 계속 증가하고 있습니다.<br>
                            </span>
                            이를 반영하듯 아파트나 연립주택과 비교해 주거공간이<br> 쾌적하고
                            <span class="c-purple">
                                1~2인 중심 라이프타일이 잘 반영된<br> 오피스텔형 주택 선호도가 높아지고 있으며<br>
                                특히 모노팰리스와 같이 특화된 최신식 시스템을<br> 적용한 주상복합 소형아파트는<br>
            ...
            <section class="sec landing inquiry-interior-sec">
                <div class="interior-wrapper">
                    <div class="interior-content group">
                        <h1 class="title-type1 title">
                            <img src="http://img.monopalace.com/landing/inquiry/interior/title.png" alt="인테리어">
                        </h1>
                        <figure class="picture ta-center">
                            <img src="http://img.monopalace.com/m/landing/inquiry/interior/img_1.png" alt="전층 복도 테마가 있는 아트갤러리">
                            <img src="http://img.monopalace.com/m/landing/inquiry/interior/img_2.png" alt="심플하고 고급스러운 인테리어">
                        </figure>
                    </div>
                </div>
            </section>
            ...
            <section class="sec landing inquiry-system-sec">
                <div class="system-wrapper">
                    <div class="system-content group">
                        ...
                        <figure class="picture ta-center">
                            <img src="http://img.monopalace.com/m/landing/inquiry/system/img_1.png" alt="시스템사진들">
                        </figure>
                    </div>
                </div>
            </section>
                ...
                <div class="plan-wrapper">
                    <div class="plan-content">
                        ...
                        <p class="subtitle-type1 subtitle fw-m">
                            ...
                            <span class="c-blue">기존 삼성디스플레이를 비롯한 대규모 산업단지와<br> 신규 개발호재</span>로 많은 인구집중이 예상되어<br>
                            풍부한 임대수요를 기대할 수 있습니다.<br>
                        </p>
                        <figure class="picture ta-center pd-m">
                            <img src="http://img.monopalace.com/m/landing/inquiry/plan/img_1.png" alt="2030년 아산시 인구목표 차트그래프">
                        </figure>
                        <p class="subtitle-type1 subtitle-2">
                            아산시는 12년간 평균 3.7%의 인구증가,<br> 세대수는 3.44%의 증가<br>
                            <span class="c-blue">핵가족화 진행 및 외부 유입 세대 1~2인 세대가 대다수!</span>
                        </p>
                        <div class="picture-list">
                            <div class="picture">
                                <img src="http://img.monopalace.com/landing/inquiry/plan/img_2.png" alt="2030년 교통망 구성 계획">
                                <p class="text">
                                    아산과 천안에 <span class="c-blue">핵심 인프라가 될 아산 천안간 고속도로가
                                        2020년 준공예정</span>으로 경부고속도로와 연계 당진-아산-천안을
                            ...
                            <div class="picture">
                                ...
                                <p class="text">
                                    아산시는 전체 면적 557.21㎢ 을 권역별 주요 개발계획으로
                                    <span class="c-purple">온양을 중심으로 한 중앙권(행정, 문화, 상업)</span>, 음봉탕정을 중심으로 한
                                    동부권(첨단산업), 인주/둔포를 중심으로 한 북부권(첨단융합산업)으로
                                    <span class="c-red fw-b">인구증가 = 부동산가치상승</span>이 예상됩니다.<br>
                                </p>
                            </div>
                            <div class="picture type2 mt">
                                <img src="http://img.monopalace.com/m/landing/inquiry/plan/img_4.png" alt="아산시 산업단지">
                                <p class="text">
                                    아산 지역의 산업단지내 고용인원은 약 31,500여명이며
                                    <span class="c-blue">산업단지 내에는 삼성전자, 삼성SDI, 삼성디스플레이,
                                        LS산전, 현대모비스 등 대기업이 대규 모로 분포</span>하고
                                    협력업체와 함께 입지하고 있습니다.
                ...
                <div class="location-wrapper">
                    <div class="location-content group-f">
                        ...
                        <table class="location-tbl">
                            ...
                            <tbody>
                                <tr>
                                    <th><img src="http://img.monopalace.com/mono/dot.gif" alt="dot"> 지하철</th>
                                ...
                                <tr>
                                    ...
                                    <td>송악나드리역 도보 1분 거리
                                        <p><img src="http://img.monopalace.com/info/bus_01.jpg" alt="일반">
                                            100 , 101 , 102 , 110 , 111 , 120 , 130 , 131 , 132 , 133 , 140 , 171 , 172 , 174 , 175 , 180 , 303, 810 , 820 , 830 , 840, 900 , 901 , 910 , 911 , 920 , 921 , 930 , 931 </p>
        ...
        <div class="landing-footer cf">
            <div class="tel-bar">
                <a href="tel:041-585-0003">
                    상담문의 <em class="fw-b">041)585-0003</em>
                </a>
            </div>
            <div class="footer-area">
                <address class="address">
                    <p class="inquiry c-brown">
                        상담문의 041)585-0003 I 충청남도 아산시 온천동 74-5번지
                    </p>
                    대표이사 박기범 I (주)이비즈네트웍스 I 사업자등록번호 220-87-30865<br>
                    서울특별시 강남구 테헤란로82길 15, 14층(대치동, 디아이타워)<br>
                </address>
                <small class="copyright">
                    COPYRIGHT 2014 BY <span class="c-brown">MONOPALACE</span> CO.,LTD ALL RIGHTS RESERVED.
                </small>
            </div>
        </div>
        ...
        <div class="bottombar-wrapper" id="bottombarWrapper" style="display: none">
            <div class="title-area">
                <img src="http://img.monopalace.com/m/landing/inquiry/bottombar_title.png" alt="5년간 임대수익보장!" class="bar-title">
            </div>
            <div class="number-area">
                <a href="tel:041-585-0003"><img src="http://img.monopalace.com/m/landing/inquiry/bottombar_inquiry_number.png" alt="분양문의 041 585 0003"></a>
            </div>
        </div>

        <div class="btm-rt-shorcut" id="btmRtShortcut">
            <div class="top-btn-cover">
                <a href="javascript:;" role="button" data-toggle="modal" data-target="inquiry-modal">
                    <img src="http://img.monopalace.com/m/landing/inquiry/inquiry_toggle.png" alt="상담문의모달버튼">
                </a>
    ...
    <!-- <script src="../../static/js/libs/waypoints.min.js"></script> -->
    ...
    <!-- http://static.monopalace.com/ -->
    <script type="text/javascript" src="http://static.monopalace.com/js/m/script.js"></script>
